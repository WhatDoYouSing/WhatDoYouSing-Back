...
class Post(models.Model):
    ...
    content = models.TextField(max_length=300)  # 투표감정
    ...
    scrap = models.ManyToManyField(
        "accounts.User", related_name="scraped_posts", blank=True
    )
...
class Emotion(models.Model):
    ...
    emo_post = models.ForeignKey(
        Post, related_name="emo_post", on_delete=models.CASCADE
    )
    emo_user = models.ForeignKey(
        "accounts.User", related_name="emo_user", on_delete=models.CASCADE
    )
